...
fun ScannerScreen(
    ...
    val latestProfileId by rememberUpdatedState(activeProfileId)
    ...
    Scaffold(
        ...
        Column(
                ...
                if (!hasActiveProfile) {
                    ...
                    CameraPreview(
                        onBarcodeScanned = { barcode ->
                            val profileId = latestProfileId ?: return@CameraPreview
            ...
            val statusLabel = when {
                !hasActiveProfile -> "Dietary profile required"
            ...
            Button(
                onClick = {
                    val profileId = activeProfileId ?: return@Button
