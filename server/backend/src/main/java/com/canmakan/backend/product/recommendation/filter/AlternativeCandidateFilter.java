...
public class AlternativeCandidateFilter {
     ...
     */
    public static boolean isPlantMilkSubstituteCandidate(CatalogProduct candidate) {
        if (candidate == null) {
            return false;
        }
    ...
    public static boolean isWheatFlourCatalogProduct(CatalogProduct candidate) {
        if (candidate.getMainCategoryEn() != null
    ...
    public static boolean isGlutenFreeFlourSubstitute(CatalogProduct candidate) {
    ...
    public static boolean isFlourSubstitute(CatalogProduct candidate) {
        if (candidate == null || isWrapOrFlatbreadProduct(candidate)) {
            return false;
        }
        Set<String> categoryTags = CategoryTagParser.parseTags(candidate.getCategoryTags());
    ...
    public static boolean isWrapOrFlatbreadProduct(CatalogProduct candidate) {
        if (candidate == null) {
            return false;
        }
    ...
    public static boolean isPeanutButterCatalogProduct(CatalogProduct candidate) {
        if (candidate == null) {
            return false;
        }
        if (candidate.getMainCategoryEn() != null
    ...
    public static boolean isPeanutFreeSpreadSubstitute(CatalogProduct candidate) {
    ...
    public static boolean isSauceOrSoySauceProduct(CatalogProduct candidate) {
        if (candidate == null) {
            return false;
        }
        if (candidate.getMainCategoryEn() != null
    ...
    public static boolean isLowSodiumSauceSubstitute(CatalogProduct candidate) {
    ...
    public static boolean isGlutenFreeBreadSubstitute(CatalogProduct candidate) {
        if (candidate == null) {
            return false;
        }
    ...
    public static boolean isGlutenFreeBreakfastCerealSubstitute(CatalogProduct candidate) {
        if (candidate == null) {
            return false;
        }
        Set<String> categoryTags = CategoryTagParser.parseTags(candidate.getCategoryTags());
    ...
    public static boolean containsOatToken(CatalogProduct candidate) {
        if (candidate == null) {
            return false;
        }
        String haystack = joinLower(
    ...
    public static boolean containsOatHaystack(String haystack) {
    ...
    public static boolean isIceCreamSubstitute(CatalogProduct candidate) {
    ...
    public static boolean hasDairyCatalogSignals(CatalogProduct candidate) {
        if (candidate == null) {
            return false;
        }
    ...
    public static boolean isDairyFreeFrozenDessert(CatalogProduct candidate) {
    ...
    public static boolean hasLowSodiumPreference(List<RestrictionRule> rules) {
        if (rules == null || rules.isEmpty()) {
            return false;
        }
