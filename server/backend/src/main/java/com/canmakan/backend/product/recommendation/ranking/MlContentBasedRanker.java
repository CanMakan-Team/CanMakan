 ...
 */
@Service
public class MlContentBasedRanker {
    ...
    public MlContentBasedRanker(ProductFeatureEncoder featureEncoder) {
        this.featureEncoder = featureEncoder;
    }

    public List<AlternativeProductRanker.RankedAlternative> rank(
