-- =============================================================================
-- CanMakan schema (dictionary table/column names preserved)
...
CREATE TABLE families (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    KEY idx_families_created_by_user_id (created_by_user_id),
...
CREATE TABLE family_invitations (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    KEY idx_family_invitations_family_id (family_id),
    KEY idx_family_invitations_invited_email (invited_email),
...
CREATE TABLE dietary_profiles (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    KEY idx_dietary_profiles_family_id (family_id),
...
CREATE TABLE dietary_restrictions (
    ...
    KEY idx_dietary_restrictions_category (category)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE profile_restrictions (
    ...
    KEY idx_profile_restrictions_restriction_id (dietary_restriction_id),
...
CREATE TABLE ingredients (
    ...
    KEY idx_ingredients_root_allergen (root_allergen)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE scans (
    ...
    KEY idx_scans_user_id (user_id),
    KEY idx_scans_profile_id (profile_id),
    KEY idx_scans_barcode (barcode),
    KEY idx_scans_scanned_at (scanned_at),
    KEY idx_scans_verdict (verdict),
...
CREATE TABLE ai_execution_logs (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    KEY idx_ai_execution_logs_scan_id (scan_id),
    KEY idx_ai_execution_logs_execution_tier (execution_tier),
...
CREATE TABLE plan_features (
    ...
    KEY idx_plan_features_feature_id (feature_id),
...
CREATE TABLE feature_usage (
    ...
    KEY idx_feature_usage_family_id (family_id),
    KEY idx_feature_usage_feature_id (feature_id),
...
CREATE TABLE admin_audit_logs (
    ...
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    KEY idx_admin_audit_logs_admin_user_id (admin_user_id),
